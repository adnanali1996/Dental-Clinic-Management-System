...
if (isset($opslaan)) {
	...
	if (!empty($cat1_textfield) AND !empty($cat2_textfield) AND !empty($cat4_textfield)) {
		# code...
		...
		else
		{
			...
			if ($num1) {
				...
				# code...
				 ...
				 $q2=mysqli_query($conn, "SELECT * FROM procedure_attribute WHERE attribute_name='$cat3_textfield'");
			     $num2=mysqli_num_rows($q2);
			     if ($num2) {
			     	# code...
			     	echo '<script type="text/javascript">alert("Procedures Subcategory Attribuate Exist.");</script>';
			     } 
			     else {
			     	# code...
			     	mysqli_query($conn, "INSERT INTO procedure_attribute VALUES ('', '$cat3_textfield', '$procedure_subcat_id')");
			     	$q3=mysqli_query($conn, "SELECT * FROM procedure_attribute WHERE attribute_name='$cat3_textfield'");
						...
						# code...
							if ($option101=="A") {
								...
								if (!empty($single_procedure_price) AND !empty($single_addl_pontic_price)) {
								    ...
								    mysqli_query($conn, "INSERT procedure_per_proce VALUES ('', '$abbreviation', '$cat4_textfield', '$price1', '$price2', '$attri_id')");
								} else {
									# code...
									echo '<script type="text/javascript">alert("Please Enter The Price.");</script>';
								}
							...
							elseif ($option101=="B") {
								...
								if (!empty($single_tooth_simple_procedure_price) AND !empty($single_tooth_moderate_procedure_price) AND !empty($single_tooth_complicated_procedure_price)) {
								    ...
								    mysqli_query($conn, "INSERT procedure_per_single VALUES ('', '$abbreviation', '$cat4_textfield', '$price1', '$price2', '$price3', '$attri_id')");
								} else {
									# code...
									echo '<script type="text/javascript">alert("Please Enter The Price.");</script>';
								}
							...
							elseif ($option101=="C"){
								if (!empty($multiple_teeth_quadrant_price) AND !empty($multiple_teeth_maxilla_price) AND !empty($multiple_teeth_mandible_price) AND !empty($multiple_teeth_maxilla_mandible_price) AND !empty($multiple_teeth_anterior_maxilla_price) AND !empty($multiple_teeth_anterior_mandible_price) AND !empty($multiple_teeth_left_posterior_maxilla_price) AND !empty($multiple_teeth_right_posterior_mandible_price) AND !empty($multiple_teeth_left_posterior_mandible) AND !empty($multiple_teeth_maxilla_mandible_price)) {
								    ...
								    mysqli_query($conn, "INSERT procedure_multiple VALUES ('', '$abbreviation', '$cat4_textfield', '$price1', '$price2', '$price3', '$price4', '$price5', '$price6', '$price7', '$price8', '$price9', '$price10', '$attri_id')");
								} else {
									# code...
									echo '<script type="text/javascript">alert("Please Enter The Price.");</script>';
								}
							...
							elseif ($option101=="D"){
								if (!empty($other_areas_upper_lip_price) AND !empty($other_areas_lower_lip_price) AND !empty($other_areas_right_cheek_price) AND !empty($other_areas_left_cheek_price) AND !empty($other_areas_tongue_price) AND !empty($other_areas_floor_price) AND !empty($other_areas_hard_palate_price) AND !empty($other_areas_soft_palate_price)) {
								    ...
								    echo $price4=$other_areas_tongue_price;
								    echo $price5=$other_areas_floor_price;
								    echo $price6=$other_areas_hard_palate_price;
								    echo $price7=$other_areas_soft_palate_price;
								    mysqli_query($conn, "INSERT procedure_per_other VALUES ('', '$abbreviation', '$cat4_textfield', '$price1', '$price2', '$price3', '$price4', '$price5', '$price6', '$price7', '$attri_id')");
								} else {
									# code...
									echo '<script type="text/javascript">alert("Please Enter The Price.");</script>';
								}
...
<th>Action</th>
            ...
            $id=$row['procedure_id'];
             ...
             while ($row2=mysqli_fetch_assoc($q2)) {
                ...
                while ( $row3=mysqli_fetch_assoc($q3)) {
                    ...
                    echo'
             <tr>
             <td>'.$row3['per_procedure_name'].'</td><th>PPr</th><td>'.$row3['ppr'].'</td><th>Pr/aP</th><td>'.$row3['prap'].'</td><td></td><td><a href="edit_pres.php"><img src="edit.gif"></a>&nbsp;&nbsp;<a href="delmaterial.php?id='.$row3['per_procedure_id'].'"><img src="del.gif"></a></td></tr>';
                }
 ...
 $q6=mysqli_query($conn,"SELECT * FROM procedure_per_single WHERE attri_id='$id2'");
                ...
                while ( $row6=mysqli_fetch_assoc($q6)) {
                    ...
                    echo'
             <tr>
             <td>'.$row6['per_name'].'</td><th>SP</th><td>'.$row6['sp'].'</td><th>MP</th><td>'.$row6['mp'].'</td><th>CP</th><td>'.$row6['cp'].'</td><td></td><td><a href="edit_pres.php"><img src="edit.gif"></a>&nbsp;&nbsp;<a href="delmaterial.php?id='.$row3['per_procedure_id'].'"><img src="del.gif"></a></td></tr>';
                }
                ...
                $q4=mysqli_query($conn,"SELECT * FROM procedure_per_other WHERE attri_id='$id2'");
                 $ee=mysqli_num_rows($q4);
                    ...
                    echo'
             <tr>
             <td>'.$row4['other_name'].'</td><td></td><th>UL</th><td>'.$row4['ul'].'</td><th>LL</th><td>'.$row4['ll'].'</td></tr><tr><td></td><td></td><th>RC</th><td>'.$row4['rc'].'</td><th>LC</th><td>'.$row4['lc'].'</td></tr><tr><td></td><td></td><th>T</th><td>'.$row4['t'].'</td><th>F</th><td>'.$row4['f'].'</td></tr><tr><td></td><td></td><th>HP</th><td>'.$row4['hp'].'</td><th>SP</th><td>'.$row4['sp'].'</td><td><a href="edit_pres.php"><a href="edit_pres.php"><img src="edit.gif"></a>&nbsp;&nbsp;<a href="delmaterial.php?id1='.$row4['other_id'].'"><img src="del.gif"></a></td></tr>';
                }}
             ...
             </tr><tr><td></td><td></td><th>RPMn</th><td>'.$row5['rpmn'].'</td><th>LPMn</th><td>'.$row5['lpmn'].'</td><td><a href="edit_pres.php"><a href="edit_pres.php"><img src="edit.gif"></a>&nbsp;&nbsp;<a href="delmaterial.php?id1='.$row4['other_id'].'"><img src="del.gif"></a></td></tr>';
                }}
