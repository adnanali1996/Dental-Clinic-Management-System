        ...
        <form method="post" action="">
            <table border="0" width="100%" class="add_edit_del_table" class="table">
                ...
                <tr>
                    ...
                    <td class="table_content"><input type="text" name="office_building_name" style="width:120px;" value=""></td>
                    ...
                    <tr>
                        ...
                        <td class="table_content"><input type="text" name="office_barangay" style="width:120px;" value=""></td>
                        <td class="table_content"><b>Province</b></td>
                        <td class="table_content"><input type="text" name="office_province" style="width:120px;" value=""></td>
                    </tr>
                    <tr>
