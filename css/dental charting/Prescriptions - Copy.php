        ...
        <div class="card card-num">
            <table id="example10" class="display responsive nowrap" style="width:100%">
             ...
             while ($row2=mysqli_fetch_assoc($q2)) {
               ...
               echo'
             <tr>
             <td>'.$row2['quantity'].'</td><td>'.$row2['price'].'</td><td>'.$row2['instruction'].'</td><td><a href="edit_pres.php"><input id="edit_chief"  type="button" value="Edit"  class="btn btn-primary"></a>&nbsp;&nbsp;<a href="delpresc.php?id='.$row2['desc_id'].'"><button id="del_chief" class="btn btn-danger download" >Delete</button></a></td></tr>';
             }
