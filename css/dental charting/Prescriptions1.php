 ...
 <?php include("views/nav-sidebar.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <div id="content-content">
                        <div id="assistance-bar" class="table-responsive">
                            
                           <div class="info_message" style="margin-left: 130;>Fill in the form underneath to add a new clinic.</div><br>
		...
		<div class="modal fade" id="example10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  ...
			  <div class="modal-body">
				<form id="updatechief">
				  <div class="form-group">
					<label for="recipient-name" class="col-form-label">acetylsalicylic_acid:</label>
