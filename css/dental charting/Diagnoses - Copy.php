...
$abbrev;
$diagnosis;
mysqli_query($conn, "INSERT INTO diagnosis VALUES (' ', '$abbrev', 'diagnosis', 'description')") or die("Not Inserted");
}
    ...
    <section class="content-header">
      ...
      <div class="row">
									...
									<tr>
										<td class="table_content" width="140px"><b>Abbreviation</b></td>
										   <td class="table_content" colspan="2">
											<input type="text" name="abbrev" id="option4" value="" style="width: 120px"> <span class="mandatory_field">*</span>
										</td>
									</tr>
									<tr>
										<td class="table_content" width="140px"><b>Name diagnosis</b></td>
										   <td class="table_content" colspan="2">
											<input type="text" name="diagnosis" id="option0" value="" style="width: 120px"> <span class="mandatory_field">*</span>
										</td>
									</tr>
									<tr>
										...
										<td class="table_content" style="vertical-align: top;" colspan="2">
											<textarea name="description" id="option5" style="width: 300px; height: 75px;"></textarea><br>
										</td>
									</tr>
								</tbody></table>
        ...
        <tbody>
          <?php
          include('conn.php');
          $sql=mysqli_query($conn, "SELECT * FROM diagnosis");
