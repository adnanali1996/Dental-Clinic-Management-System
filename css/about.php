...
<head>
	<title>Pak Dental About</title>
	<!--/tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Pak Dental, Balochistan Dentist, Balochistan Doctor, Android Compatible web template, 
...
<div class="container">
			<div class="header_left">
				<ul>
					<li><i class="fa fa-map-marker" aria-hidden="true"></i> Quetta, Pakistan</li>
					<li><i class="fa fa-phone" aria-hidden="true"></i> +(81) 2883559</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">Pakdentist@example.com</a></li>
				</ul>
			</div>
				...
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="index.php">
							<h1><span class="fa fa-stethoscope" aria-hidden="true"></span>Pak Dental </h1>
						</a>
					</div>
					<!--/.navbar-header-->
			...
			<div class="container">
				<div class="emergency_cases_top">
					...
					<div class="col-md-6 emergency_cases_w3ls_right">
						...
						<h5><i class="fa fa-phone" aria-hidden="true"></i>0818343458</h5>
		...
		<div class="teamgrids">
			<div class="col-md-3 teamgrid1">
				...
				<div class="teaminfo">
					...
					<p><i class="fa fa-phone" aria-hidden="true"></i> 081 1334567</p>
			...
			<div class="col-md-3 teamgrid1">
				...
				<div class="teaminfo">
					...
					<p><i class="fa fa-phone" aria-hidden="true"></i> 081 133 4568</p>
			...
			<div class="col-md-3 teamgrid1">
				...
				<div class="teaminfo">
					...
					<p><i class="fa fa-phone" aria-hidden="true"></i> 081 1334569</p>
	...
	<div class="footer_top_agile_w3ls">
		<div class="container">
			...
			<div class="col-md-3 footer_grid">
				<h3>Contact Info</h3>
				<ul class="address">
					<li><i class="fa fa-map-marker" aria-hidden="true"></i>87800, Quetta<span>Pakistan.</span></li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@example.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>081 8089436</li>
				</ul>
			</div>
			<div class="col-md-3 footer_grid ">
