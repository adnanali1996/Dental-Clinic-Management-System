    ...
    <section class="content-header">
      ...
      - Second pick a color and fill in the description of the new status.</div>
                ...
                <tr>
                  ...
                  <td class="table_content">
                    <div id="option8_content">
                       # <input class="color {required:false}" type="text" maxlength="6" size="10" name="d_score" value="" id="input_text" style="width: 110px" autocomplete="off"> (Click on the input field to pick a color)
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="table_content">
                    <div id="option8_content">
                       # <input class="color {required:false}" type="text" maxlength="6" size="10" name="m_score" value="" id="input_text" style="width: 110px" autocomplete="off"> (Click on the input field to pick a color)
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="table_content">
                    <div id="option8_content">
                       # <input class="color {required:false}" type="text" maxlength="6" size="10" name="f_score" value="" id="input_text" style="width: 110px" autocomplete="off"> (Click on the input field to pick a color)
                    </div>
                  </td>
                </tr>
