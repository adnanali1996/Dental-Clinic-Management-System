...
if (isset($submit)) {
  ...
  //echo "<script type='text/javascript'>alert('sdfsd');</script>";
   if (!empty($fname)AND !empty($lname) AND isset($gender) AND !empty($date_of_birth1) and isset($nationality) and isset($marital_status) ) {
     $sql1=mysqli_query($conn, "SELECT * FROM patients WHERE email='$email'");
      $num=mysqli_num_rows($sql1);
      if ($num) {
        # code...
        echo'<script type="text/javascript"> alert("Account Already Exists With Provided Email Address.");</script>';
      } else {
        # code...
        $dob=$date_of_birth1.'/'.$date_of_birth2.'/'.$date_of_birth3;
  $sql=mysqli_query($conn, "INSERT INTO patients VALUES (' ', 'BUITEMS', '$lname', '$mname', '$fname', '$gender', '$dob', '$nationality', '$marital_status', '$h_no', '$street', '$district', '$city', '$pro', '$postal', '$mob', '$email', '$general_comment', '$occupation', '$patient_status')");
      }
    ...
    <section class="content-header">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <b>Gender: </b><span class="mandatory_field">*</span>
					  </div>
             ...
             <input type="text" name="date_of_birth1" style="width: 70px;"  value="">
               ...
               <i>Input in yyyy mm dd</i>
                 ...
                 <b>Nationality:</b>
                  ...
                  <div class="col-md-12 form-vender vender-margin patient-name">
					  <div class="col-md-2 form-vender vender-margin patient-name">
                 <b>Marital status: </b><span class="mandatory_field">*</span>
					  </div>
					  <div class="col-md-10 form-vender vender-margin patient-name">
             ...
             <div class="col-md-3 form-vender vender-margin patient-name">
              <input type="text" name="h_no" value="">
               <span class="mandatory_field">*</span>
					  </div>
             ...
             <b>Province:</b>
              ...
              <input type="text" name="pro" value="">
               <span class="mandatory_field">*</span>
                </div>
					</div>
...
General comment about patient:</b>
					...
					<div class="col-md-12 form-vender vender-margin patient-name ">
					 ...
					 <select name="patient_status" style="width:180px;"><option value="Celebrity">Celebrity</option><option value="Family">Family</option><option value="HIV positive">HIV positive</option><option value="Regular patient" selected="">Regular patient</option><option value="VIP">VIP</option>
                    </select>
					</div>
					</div>
						</div>
