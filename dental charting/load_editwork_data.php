...
//Fetch procedures From preocedures Table and disyplay procedures by chossing different categoriesc
 ...
 {    
      ...
      {  
       	...
       	# code...
       	 $output .= '<table><tr><td><b>Price</b></td></tr><tr><td>Simple: </td><td><input style="width:100%;" type="text" placeholder="Quantity" name="Quantity1" value="1" style="width:30%;"></td><td><input style="width:100%;" type="text" name="Price1" value="'.$row['sp'].'"></td></tr><tr></tr><tr><td>Moderate: </td><td><input style="width:100%;" type="text" name="Quantity2" value="0" placeholder="Quantity" style="width:30%;"></td><td><input style="width:100%;" type="text" name="Price2" value="'.$row['mp'].'"></td></tr><tr><td>Complicated: </td><td><input style="width:100%;" type="text" name="Quantity3" value="0" placeholder="Quantity" style="width:30%;"></td><td><input style="width:100%;" type="text" name="Price3" value="'.$row['cp'].'"></td></tr></table>'; 
      ...
      {  
		...
		<tr>
			<td>Quadrant: </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="1" name="Quantity1" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price1" value="'.$row1['q'].'"></td>
		</tr>
		<tr>
			<td>Maxilla: </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity2" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price2" value="'.$row1['mx'].'"></td>
		</tr>
		<tr>
			<td>Mandible </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity3" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price3" value="'.$row1['mn'].'"></td>
		</tr><tr>
			<td>Maxilla and Mandible </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity4" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price4" value="'.$row1['mxmn'].'"></td>
		</tr><tr>
			<td>Anterior Maxilla </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity5" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price5" value="'.$row1['amx'].'"></td>
		</tr><tr>
			<td>Anterior Mandible </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity6" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price6" value="'.$row1['amn'].'"></td>
		</tr><tr>
			<td>Right Posterior Maxilla </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity7" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price7" value="'.$row1['rpmx'].'"></td>
		</tr>
		<tr>
			<td>Left Posterior Maxilla </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity8" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price8" value="'.$row1['lpmx'].'"></td>
		</tr>
		<tr>
			<td>Right Posterior Mandible </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity9" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="Price9" value="'.$row1['rpmn'].'"></td>
		</tr>
		<tr>
			<td>Left Posterior Mandible </td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="Quantity10" style="width:30%;"></td>
 ...
 {    
      ...
      {  
       	...
       	# code...
       	 $output .= '<table><tr><td><b>Price</b></td></tr><tr><td>'.$row['per_price'].'</td><td><input style="width:100%;" type="text" placeholder="Quantity" value="1" name="MQuantity1" style="width:30%;"></td><td><input style="width:100%;" type="text" name="MPrice1"  value="'.$row['price'].'"></td></tr></table>'; 
      ...
      if ($num1) {
		...
		<tr>
			...
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="1" name="MQuantity1" style="width:30%;"></td>
      ...
      $result2 = mysqli_query($connect, $sql2);  
		...
		<tr>
			<td>Medium</td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="MQuantity2" style="width:30%;"></td>
			<td><input style="width:100%;" type="text" name="MPrice2"  value="'.$row2['medium'].'"></td>
		</tr>
		<tr>
			<td>Large</td>
			<td><input style="width:100%;" type="text" placeholder="Quantity" value="0" name="MQuantity3" style="width:30%;"></td>
