        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Unbilled</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card card-num">
            <table id="example" class="display responsive nowrap" style="width:100%">
			  ...
			  if (isset($_GET['p_id'])) {
			  	...
			  	global $sql;
			  	$p_id=$_GET['p_id'];
			  	$sql=mysqli_query($conn, "SELECT * FROM bill WHERE patient_id='$p_id' AND payment=0");
			  	$num=mysqli_num_rows($sql);
			  	if (!$num) {
			  		# code...
			  		echo'<h1>No Unbilled Record Found</h1>';
			  		exit();
			  	}
			  } 
			  else {
