...
Subscription(s)</th>
        ...
        <tbody>
            ...
            <tr>
					<td><i class="icon fa fa-pencil-square-o">&nbsp;30 days subscription</i></td>
                  <td>10
                  ...
                  <td>2018-05-24</td>
                  <td>1</td>
					<td><a href="#"><i class="icon fa fa-file-text-o"></i></a>&nbsp; &nbsp;<button type="button" class="btn btn-default button-invoice reniew-sub"><a href="#">Renew your subscription</a></button> </td>
                   <td></td>
...
Application rights</th>
             <th></th>
                ...
                <tr>
					<td><i class="icon fa fa-wrench">&nbsp;	Manage user groups (permissions / rights)</i></td>
                  <td><i class="icon fa fa-pencil"></i>
...
Clinic</th>
          ...
          <td><i class="icon fa fa-building-o"></i>'.$row['clanic_name'].'</td>
                ...
                <thead>
                <tr class="country">
                  <th><a href="#"></a>&nbsp; &nbsp;<button type="button" class="btn btn-default button-invoice reniew-sub"><a href="#">Add clinic</a></button></th>
            ...
            <div class="alert alert-info alert-dismissible">
                  ...
                  <h5><i class="icon fa fa-info"></i>Manage your users</h5>
                
               DentalCharting allows multiple users.<br>
                
               
				To add a user to access your clinic's data click on the<b> "Add user"</b> button and fill out the form.
...
Users</th>
        ...
        <tbody>
            ...
            <tr>
					<td><i class="icon fa fa-user">&nbsp;91744</i></td>
                  <td>Anees khattak</td>
                 <td>	All clinics</td>
                  <td>Account holder</td>
                  <td><i class="icon fa fa-pencil"></i>&nbsp;<i class="icon fa fa-lock">&nbsp; <a href="#">Edit password</a></i>&nbsp; &nbsp;<i class="icon fa fa-lock">&nbsp; <a href="#">Send a new password</a><br>
