...
if (isset($opslaan)) {
	...
	if (!empty($office_organisation_name) AND !empty($office_street) AND !empty($office_house_number) AND !empty($office_postal_code) AND !empty($office_city) AND !empty($office_barangay) AND !empty($office_province)AND !empty($office_phone_number)AND !empty($office_email)AND !empty($office_tin_number)) {
		...
		mysqli_query($conn, "INSERT INTO `clanic` (`id`, `clanic_name`, `building_name`, `office_num`, `street`, `street_num`, `country`, `postal_code`, `city`, `district`, `province`, `phone_num`, `fax_num`, `mob_num`, `email_add`, `govt_name`, `govt_regiter_num`, `company_tax`, `clanic_manager`) VALUES ('', '$office_organisation_name', '$office_building_name', '$office_building_office_number', '$office_street', '$office_house_number', '$office_country', '$office_postal_code', '$office_city', '$office_barangay', '$office_province', '$office_phone_number', '$office_fax_number', '$office_mobile_number', '$office_email', '$office_dti_sec_reg_name', '$office_dti_sec_reg_number', '$office_tin_number', '$person_responsible_l_name')");
        ...
        <form method="post" action="">
            <table border="0" width="100%" class="add_edit_del_table" class="table">
                ...
                <tbody><tr>
                    ...
                    <td class="table_content" width="130"><input type="text" name="office_dti_sec_reg_name" style="width:120px;" value=""></td>
                    <td class="table_content" width="130"><b>Gov't registered #</b></td>
                    <td class="table_content" width="130"><input type="text" name="office_dti_sec_reg_number" style="width:120px;" value=""></td>
                    <td class="table_content" width="40"><b>Company TAX #</b></td>
                    <td class="table_content"><input type="text" name="office_tin_number" style="width:120px;" value=""> <span class="mandatory_field">*</span></td>
                </tr>
                </tbody></table>
                ...
                <table border="0" width="100%" class="add_edit_del_table">
                    ...
                    <tr>
                        ...
                        <td class="table_content" width="195">
                            ...
                            <input type="text" name="person_responsible_l_name" style="width:120px;" value="">
                        </td>
