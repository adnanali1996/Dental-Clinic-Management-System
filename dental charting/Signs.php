    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Signs and symptoms</li>
            </ol>
          </div>
        </div>
      </div>
      <div class="row">
         ...
         <div class="add-maintain">
        	<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
				...
				<div class="collapse" id="collapseExample">
				  <div class="card">
					   <form id="signs" class="add-chief-form">
								<table border="0" width="100%" class="add_edit_del_table">
									...
									<tr>
										<td colspan="3">
											<div class="info_message">In order to add a sign or symptom you have to fill in the name and description of the new sign or symptom.</div>
										</td>
									</tr>
									<tr>
										<td class="table_content" width="140px"><b>Name sign or symptom</b></td>
										<td class="table_content" colspan="2">
											<input type="text" name="sname" id="sname" value="" style="width: 120px"> <span class="mandatory_field">*</span>
										</td>
									</tr>
									<tr>
										...
										<td class="table_content" style="vertical-align: top;" colspan="2">
											<textarea name="sdesc" id="sdesc" style="width: 300px; height: 75px;"></textarea><br>
										</td>
									</tr>
								</tbody></table>
        ...
        <div class="card card-num">
            <table id="signs_table" class="display responsive nowrap" style="width:100%">
...
<script src="dist/js/signs.js" type="text/javascript"></script>
<script>
  $(function () {
    $("#example1").DataTable();
    $('#example2').DataTable({
