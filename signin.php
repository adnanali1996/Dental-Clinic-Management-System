      ...
      $result = $conn->query($sql);
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                echo $row['email'];
                $dentist_name=$row['u_name'];
                $dentist_id=$row['user_id'];
                $_SESSION['dentist_name']=$dentist_name;
                $_SESSION['dentist']=$dentist_id;
               // if(isset($_SESSION['dentist'])){echo "SET Dentist";}
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                $_SESSION['admin']=$email;
                 ...
                 //if(isset($_SESSION['admin'])){echo "SET Admin";}
